...
using Payzi.MySQL.Model.Enumerate;
using System;
...
namespace Payzi.MySQL.Model.Business
{
    public static class Account
    {
        public class LoginParametros
        {
            ...
            public Payzi.MySQL.Model.Context? Context { get; set; }
        }
        ...
        public static async Task<(LoginStatus loginStatus, string accessToken)> Logear(LoginParametros loginParametros)
        {
            ...
            //Aqui
            Usuario usuario = await Usuario.GetAsync(loginParametros.Context, loginParametros.Email);
            ...
            try
            {
                ...
                string accessToken = Payzi.MySQL.Model.Business.AccessToken.GenerateAccessToken(usuario);
